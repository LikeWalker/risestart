...
<body>
			...
			<div class="header__wrapper">
				...
				<nav class="header__nav">
					<ul class="header__list">
						...
						<li class="header__item">
							<a href="login.php" class="header__link">Личный кабинет</a>
						</li>
					</ul>
				</nav>
			</div>
					...
					<input checked type="radio" name="respond" id="desktop">
						<article id="slider">
							...
							<div id="slides">
								<div id="overflow">
									<div class="image">
										<article><a href=""><img class="impd1" src="img/1.jpg"></a></article>
										<article><a href=""><img class="impd2" src="img/2.jpg"></a></article>
										<article><a href=""><img class="impd3" src="img/3.jpg"></a></article>
										<article><a href=""><img class="impd4" src="img/4.jpg"></a></article>
										<article><a href=""><img class="impd5" src="img/5.jpg"></a></article>
									</div>
								</div>
							</div>
							<div id="controls">
			...
			<div class="service__cards">
				<div class="service__card">
					<div class="service__card__pic">
						...
						<a href="" class="service__card__more d1">&emsp;&emsp;Помочь&emsp;&emsp;</a>
					</div>
				</div>
				<div class="service__card">
					<div class="service__card__pic">
						...
						<a href="" class="service__card__more d2">&emsp;&emsp;Помочь&emsp;&emsp;</a>
					</div>
				</div>
				<div class="service__card">
					<div class="service__card__pic">
						...
						<a href="" class="service__card__more d3">&emsp;&emsp;Помочь&emsp;&emsp;</a>
					</div>
				</div>
			</div>
			<h2 class="service__title section__title">
			...
			<div class="service__cards">
				<div class="service__card">
					<div class="service__card__pic">
						...
						<a href="" class="service__card__more d4">&emsp;&emsp;Помочь&emsp;&emsp;</a>
					</div>
				</div>
				<div class="service__card">
					<div class="service__card__pic">
						...
						<a href="" class="service__card__more d5">&emsp;&emsp;Помочь&emsp;&emsp;</a>
					</div>
				</div>
				<div class="service__card">
					<div class="service__card__pic">
						...
						<a href="" class="service__card__more d6">&emsp;&emsp;Помочь&emsp;&emsp;</a>
					</div>
				</div>
			</div>
			<h2 class="service__title section__title">
			...
			<div class="service__cards">
				<div class="service__card">
					<div class="service__card__pic">
						...
						<a href="" class="service__card__more d7">&emsp;&emsp;Помочь&emsp;&emsp;</a>
					</div>
				</div>
				<div class="service__card">
					<div class="service__card__pic">
						...
						<a href="" class="service__card__more d8">&emsp;&emsp;Помочь&emsp;&emsp;</a>
					</div>
				</div>
				<div class="service__card">
					<div class="service__card__pic">
						...
						<a href="" class="service__card__more d9">&emsp;&emsp;Помочь&emsp;&emsp;</a>
					</div>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		let impd1 = document.querySelector('.impd1');
		let impd2 = document.querySelector('.impd2');
		let impd3 = document.querySelector('.impd3');
		let impd4 = document.querySelector('.impd4');
		let impd5 = document.querySelector('.impd5');
		let d1 = document.querySelector('.d1');
		let d2 = document.querySelector('.d2');
		let d3 = document.querySelector('.d3');
		let d4 = document.querySelector('.d4');
		let d5 = document.querySelector('.d5');
		let d6 = document.querySelector('.d1');
		let d7 = document.querySelector('.d2');
		let d8 = document.querySelector('.d3');
		let d9 = document.querySelector('.d4');
		impd1.onclick = function(){
			alert('Извините, но для использования данного раздела, нужно войти в учетную запись' );
		}
		d2.onclick = function(){
			alert('Извините, но для использования данного раздела, нужно войти в учетную запись' );
		}
